...
def find_heroes(name_list, url=url_for_search):
    global hero_intel_dict, hero_intel_list
    hero_list = {}
    for hero in name_list:
        hero_list[hero] = Heroes(url, hero)
...
dict1, list1 = find_heroes(['Hulk', 'Captain America', 'Thanos'])
